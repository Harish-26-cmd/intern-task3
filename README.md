...
# Task 3 – Customized Mazer Dashboard

## Overview
Customized Mazer Admin Dashboard as part of a Front-End Skill Assessment.

## Features
- Bootstrap 5 UI customization
- Data-driven dashboard using JSON
- Fetch API with ES6
- Responsive admin layout

## How to Run
Open index.html or deploy using GitHub Pages.
